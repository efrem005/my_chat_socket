    ...
    return function (t) {
        ...
        var l = n(8), p = n(1), h = n(0), y = n(6), d = n(4), v = function (t) {
            ...
            return e = p, (n = [{
                ...
                key: "onOpen", value: function () {
                    if (this.readyState = "open", p.priorWebsocketSuccess = "websocket" === this.transport.name, this.emit("open"), this.flush(), "open" === this.readyState && this.opts.upgrade && this.transport.pause) for (var t = 0, e = this.upgrades.length; t < e; t++) this.probe(this.upgrades[t])
                }
            }, {
                key: "onPacket", value: function (t) {
        ...
        var u = n(3), f = n(0), l = n(4), p = n(12), h = n(13).pick, y = n(29), d = y.WebSocket,
